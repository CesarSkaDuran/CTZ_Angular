...
@Component({
    selector: 'app-cambiarProducto-modal',
    templateUrl: './cambiarProducto-modal.component.html',
    styleUrls: ['./cambiarProducto-modal.component.scss']
})
export class CambiarProductoModalComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    constructor(
        public dialogRef: MatDialogRef<CambiarProductoModalComponent>,
    ...
    save() {
        ...
        //  const patient_id = this.data.appointment ? `patient_id: ${this.data.appointment.patient_id},` : `patient_id: ${data.cliente.id}`;
        // const status = `status: ${data.status},`;
        // const name = `name: "${data.cliente.name}",`;
        const type_concreto =  `type_concreto:"${data.type_concreto.nombre}",`;
        const id_type_concreto =  `id_type_concreto:${data.type_concreto.id},`;
        ...
        //const vendedor = `vendedor: "${data.vendedor.name}",`;
        // const conductor = `conductor: "${data.conductor.name}",`;
        const queryParams = ` ${id}  ${type_concreto} ${id_type_concreto}`;
        const queryProps = 'id, type_concreto';
