...
@Component({
    selector: 'app-appointmentConductor',
    templateUrl: './appointmentConductor.component.html',
    styleUrls: ['./appointmentConductor.component.scss']
})
export class AppointmentConductorComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    constructor(
        public dialogRef: MatDialogRef<AppointmentConductorComponent>,
    ...
    save() {
        ...
        const queryParams = ` ${id} ${conductor} `;
        const queryProps = 'id, ';
